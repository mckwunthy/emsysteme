                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page"
                            href="<?php echo BASE_URL . SP . 'connexion'; ?>">Event</a>
                    </li>
                    <?php
                    //profil si connecté
                    if (isset($_SESSION["user"])) {
                        echo '
                         <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="' . BASE_URL . SP . 'profil">Profil and Events</a>
                        </li>
                        ';
                    }
                    ...
                    if (isset($_SESSION["user"])) {
                        ...
                        <a class="nav-link" href="' . BASE_URL . SP . 'booking">Booking</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="' . BASE_URL . SP . 'managevents">Manage Events</a>
                    </li>
                </ul>';
                    }
                    ?>
